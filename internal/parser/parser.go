...
// parseListInBraces is a helper function to parse comma-separated lists within braces.
// It handles the pattern: { item1, item2, ... }
// The parseItem function is called for each item in the list.
func parseListInBraces[T any](p *Parser, parseItem func() (T, error)) ([]T, error) {
